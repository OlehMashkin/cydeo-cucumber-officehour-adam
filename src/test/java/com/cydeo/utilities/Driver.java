...
public class Driver {
    ...
    public static WebDriver getDriver(){
        ...
        if(driver == null){
            ...
            This way, we will control which browser is opened from outside our code.
             */
    ...
    public static void closeDriver(){
        if(driver!=null){
            /*
            This line will terminate the currently existing driver completely. It will be non-exist going forward.
             */
            driver.quit();
            /*
